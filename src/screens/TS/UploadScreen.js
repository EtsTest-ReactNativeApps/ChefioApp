...
import CameraPicker from '../../hooks/CameraPicker'
    ...
    <ScrollView>
      <Container>
        ...
        <Input
          isDescription
          Height={'150px'}
          inputPlaceHolder={'Tell a little about your food'}
        ></Input>
        <Row direction={'flex-start'}>
        ...
        <VerticalSpace />
        <Row>
          <Text style={sliderValue > 1 ? styles.inSliderStyle : styles.outSliderStyle}>
            {'< 10'}
          </Text>
          <HorizontalSpace width={'90px'} />
          <Text style={sliderValue >= 30 ? styles.inSliderStyle : styles.outSliderStyle}>
            {'30'}
          </Text>
          <HorizontalSpace width={'90px'} />
          <Text style={sliderValue >= 60 ? styles.inSliderStyle : styles.outSliderStyle}>
            {'> 60'}
          </Text>
        </Row>
        <Slider
